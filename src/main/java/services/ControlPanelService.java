...
public class ControlPanelService {
    ...
    public List<WebElement> getListOfTeamMembers(){
    ...
    public void showProjectUsersHighlight(){
        controlPanelBlock.highlightElement(controlPanelBlock.getUserSelectorButton());
    }

    public void showProjectUsersUnhighlight(){
        controlPanelBlock.unHighlightElement(controlPanelBlock.getUserSelectorButton());
    }

    public void noProjectAvailableHighlight(){
        controlPanelBlock.highlightElement(controlPanelBlock.getNoProjectAvailableMessage());
    }

    public void noProjectAvailablUnhighlight(){
        controlPanelBlock.unHighlightElement(controlPanelBlock.getNoProjectAvailableMessage());
    }
  }
