...
public class ProjectsBlock {
    ...
    private By activityValueInserted = By.xpath("//input[contains(@title, 'Daily sync-up')]");//todo
    ...
    private By workingDayCellFilled = By.xpath("//div[@class='table-activity-cell cell']//input[@value='0.5']");// dirty

    private By saveHoursButton = By.xpath("//nav[@class='controller-panel']//button[@class='green button']");//control panel
    private By monthsView = By.xpath("//a[@class='switch-item' and contains (text(), 'month')]");//control panel

    private By totalHours = By.cssSelector("#total-reported-period");
    private By exportToExcelButton = By.xpath("//span[@class='title' and contains (text(), 'Export to Excel')]");//todo remove

    private By exportButton = By.xpath("//span[@class = '' and contains (text(), 'Export')]");//export excell block

    private By currentUser = By.xpath("//span[@class='name']//span[@class='display-value']");//todo remove

    private By teamMember = By.xpath("//article[@class='member']");//control panel

    private By switchTimePeriodButton = By.xpath("//a[@class='switch-item']");//control panel
    private By searchButton = By.xpath("//div[@class='magnifying-glass']");//control panel

    private By someUserName = By.xpath("//span[@class='full-name' and contains(text(), 'Alexey Alexandrov')]");//dirty remove

    private By searchField = By.xpath("//input[@type='search']");//control panel

    private By cancelButton = By.xpath("//div//button[@class='white button' and contains (text(), 'CANCEL')]");//control panel

    private By timeRangeNotCurrent = By.xpath("//div[@class='item-day in-current-month']");//table journal

    private By calendarButton = By.xpath("//span[@class='date-value']");//control panel  todo new class

    private By workingDayColumnDate = By.xpath("//div[@class='journal-day cell']");//rename
