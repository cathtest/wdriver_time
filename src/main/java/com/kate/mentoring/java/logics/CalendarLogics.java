...
public class CalendarLogics {
    ...
    private KathyLog kathyLog;
    private CalendarService calendarService;

    public CalendarLogics() {
        this.calendarService = new CalendarService();
        this.kathyLog = new KathyLog();
    }
    ...
    public void openYear(int yearChosen) {
        ...
        KathyLog.trace("Searching for the year chosen\n");
        ...
        if (startYearInt < yearChosen && yearChosen > endYearInt) {
            for (int i = yearChosen; startYearInt < i && i > endYearInt; i++) {
                ...
                KathyLog.info(startYearInt + " " + endYearInt);
            }
    ...
    private void clickOnYear(int yearChosen){
        try {
            ...
            KathyLog.error("Error detected: StaleElementReferenceException!", ex);
        }
    }
