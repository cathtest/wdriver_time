...
//        tableJournalService.sendKeysToTheActivity("Next activity");
    ...
    public void checkThereIsNoProjectAvailableForInvalidTimePeriod() {
        logManager.loggingInfo("Clicking Calendar button");
        calendarService.calendarButtonClick();
        calendarService.calendarButtonHighlight();
        calendarService.calendarButtonUnhighlight();
        logManager.loggingInfo("Opening Month view");
        calendarLogics.openMonthView();
        calendarService.changeRangeHighlight();
        calendarService.changeRangeUnhighlight();
        logManager.loggingInfo("Opening Year view");
        calendarLogics.openYearView();
        calendarService.changeRangeHighlight();
        calendarService.changeRangeUnhighlight();
        ...
        logManager.loggingInfo("Opening the first month in the year");
        calendarService.firstMonthInTheYearHighlight();
        calendarService.firstMonthInTheYearUnhighlight();
        calendarService.firstMonthInTheYearClick();
        logManager.loggingInfo("Opening the time range that is not current");
        calendarService.notCurrentTimeRangeHighlight();
        calendarService.notCurrentTimeRangeUnhighlight();
        calendarService.clickNotCurrentTimeRange();
        logManager.loggingInfo("Clicking to shown users available on the project");
        controlPanelService.clickToShowProjectUsers();
        controlPanelService.showProjectUsersHighlight();
        controlPanelService.showProjectUsersUnhighlight();
        ...
        controlPanelService.noProjectAvailableHighlight();
        controlPanelService.noProjectAvailablUnhighlight();
    ...
    public void checkMouseState(){
        ...
        Assert.assertNotEquals(colourBeforeMouseHover, colourAfterMouseHover, "The colour is not chanded after moving to the element");
    }
    ...
    public void dDrop(){
        Actions builder = new Actions(DriverManager.getInstance().getDriver());
        sideBar.getSideBarIcon().click();
        Sleeper.sleep(2);
        builder.dragAndDrop(sideBar.getLearn(), sideBar.getSearchField()).build().perform();
