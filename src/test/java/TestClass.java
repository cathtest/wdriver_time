...
public class TestClass extends TestCase {
    ...
    public void checkAllUsersAreAvailableAndThersTotalHours() {
        ...
        int quantityOfTeamMembers = 89;//todo
        String regEx = "^Total\\s((152)\\W)(?=152)|((160)\\W)(?=160)|((168)\\W)(?=168)";
        for (int i = 0; i < quantityOfTeamMembers; i++) {
            ...
            for (WebElement element : listOfTeamMembers) {//todo 4.1
    ...
    public void checkTwoEqualActivitiesCannotBeAdded() {
        ...
        try {
            ...
            tableJournalService.sendHoursToEmptyCell("0.5"); //todo
        ...
        Assert.assertEquals(tableJournalService.getTextFromEmptyCell(), "", "There was an error, the hours for the Activity with the same name have been added");
    }
