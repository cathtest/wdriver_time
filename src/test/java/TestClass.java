...
public class TestClass extends TestCase {
    ...
    public void checkAddHoursWorkCorrectly() {
        ...
        smallQuantity.performSmallQuantityFilling();
    ...
    public void checkTotalTimeIsChanged() {
        ...
        logManager.loggingInfo("Sending keys to the activity");
        fillingActivityServiceSecond.fill();
    ...
    public void checkDataNotSavedAfterClickingCancel() {
        ...
        logManager.loggingInfo("Sending keys to the activity");
        fillingActivityServiceForth.fill();
    ...
    public void checkOvertimeHoursCanBeCanceled() {
        ...
        logManager.loggingInfo("Sending keys to the activity");
        fillingActivityServiceSixth.fill();
    ...
    public void checkItIsForbiddenToAddMoreThanTwentyFourHoursPerDay(){
        ...
        bigQuantity = new TwentyFiveQuantity();
        bigQuantity.performBigQuantityFilling();
        Sleeper.sleep(1);
