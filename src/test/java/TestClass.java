...
public class TestClass {
    ...
    Calendar calendar;
    OvertimeCancelling overtimeCancelling;
    ...
    public void startBrowser(){
        ...
        warningMessages = new WarningMessages(driver);
        overtimeCancelling = new OvertimeCancelling(driver);
...
//    }
    ...
    public void checkTwoEqualActivitiesCannotBeAdded(){
        ...
        Assert.assertEquals(tableJournalBlock.getEmptyCell().getText(), empty, "There was an error, the hours for the Activity with the same name have been added");
    ...
    @Test(description =
            ...
            "\n 10. Click to save" +
            "\n 11. Renew the page and verify overtime stays canceled")
    ...
    @Test(description =
            ...
            "\n 5. Choose one of the cells as an overtime cell" +
            "\n 6. Click to Save" +
            "\n 7. Verify that Overtime hours have been added to the total reported time")
    public void checkOvertimeoursCanBeSaved(){
        tableJournalBlock.getAddActivityButtonList().get(0).click();
        tableJournalBlock.getActivityField().sendKeys("Daily sync-up");
        tableJournalBlock.getWorkingDaysList().forEach(cell -> {
            cell.sendKeys("0.5");
    ...
    public void checkExportUnavailableForMoreThanYearPeriod(){
        exportExcellBlock.getExportToExcelButton().click();
        exportExcellBlock.getRightCalendar().click();
        calendar.getAnotherView().click();
        calendar.getAnotherView().click();
